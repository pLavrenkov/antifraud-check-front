        ...
        <section className="new-search-popup">
            ...
            <ul className="new-search-popup__container">
                ...
                }
                {
                    ...
                    <li className="new-search-popup__btn-place">
                        <Link to={"/buisness"} target={'_blank'} disabled={isDisabled} className={isDisabled ? "new-search-popup__link new-search-popup__link_type_disabled" : "new-search-popup__link"} onClick={handlePrevent}>
                            <button type="button" onClick={onNameClick} disabled={isDisabled} className={isDisabled ? "new-search-popup__btn new-search-popup__btn_type_disabled" : "new-search-popup__btn"}>ФИО / НАИМЕНОВАНИЕ или АДРЕС</button>
                        </Link>
                        <span className="new-search-popup__description">найдем всех юридических лиц или индивидуальных предпринимателей по ФИО / названию или адресу и можно будет посмотреть подробности</span>
                    </li>
                }
            </ul>
        </section>
